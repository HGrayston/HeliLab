  ...
  ;%*******************
    ...
    ;%
	  ...
	  ;% heli_q8_DW.eref_PWORK.LoggedData
	  ...
	  ;% heli_q8_DW.ec_PWORK.LoggedData
	  section.data(11).logicalSrcIdx = 24;
	  section.data(11).dtTransOffset = 10;
	
	  ;% heli_q8_DW.pc_PWORK.LoggedData
	  ...
	  ;% heli_q8_DW.pref_PWORK.LoggedData
  ...
  targMap.checksum0 = 1616719775;
  targMap.checksum1 = 995518266;
  targMap.checksum2 = 3881183751;
  targMap.checksum3 = 3529951109;
