 ...
 * C source code generated on : Wed Sep 20 15:43:20 2023
 *
...
void heli_q8_output0(void)             /* Sample time: [0.0s, 0.0s] */
{
    ...
    /* S-Function Block: heli_q8/Heli 3D/HIL Read Encoder Timebase (hil_read_encoder_timebase_block) */
    {
      ...
      if (result < 0) {
        ...
        rtb_HILReadEncoderTimebase_o1 =
          heli_q8_DW.HILReadEncoderTimebase_Buffer[0];
        rtb_Sum_a = heli_q8_DW.HILReadEncoderTimebase_Buffer[1];
        rtb_Sum_k = heli_q8_DW.HILReadEncoderTimebase_Buffer[2];
      }
    }

    /* Gain: '<S3>/Pitch: Count to rad' */
    heli_q8_B.PitchCounttorad = heli_q8_P.PitchCounttorad_Gain * rtb_Sum_a;

    /* Sum: '<S5>/Sum' */
    rtb_Sum_a = 0.0 - heli_q8_B.PitchCounttorad;

    /* Gain: '<S5>/Gain' */
    heli_q8_B.Gain = heli_q8_P.K_pp * rtb_Sum_a;
  }
   ...
   */
  rtb_Sum1 = heli_q8_B.Gain - (heli_q8_P.PitchTransferFcn_C *
    heli_q8_X.PitchTransferFcn_CSTATE + heli_q8_P.PitchTransferFcn_D *
    heli_q8_B.PitchCounttorad) * heli_q8_P.K_pd;
  ...
  if (rtmIsMajorTimeStep(heli_q8_M)) {
     ...
     */
    rtb_Sum_k = heli_q8_P.Constant1_Value - heli_q8_B.ElevationCounttorad;
  ...
  rtb_Backgain = ((heli_q8_X.Integrator_CSTATE + heli_q8_B.K_ep) -
                  (heli_q8_P.ElevationTransferFcn_C *
                   ...
                   heli_q8_B.ElevationCounttorad) * heli_q8_P.K_ed_Gain) +
    heli_q8_P.V_s0;
...
RT_MODEL_heli_q8_T *heli_q8(void)
{
  ...
  heli_q8_M->Sizes.numBlocks = (29);   /* Number of blocks */
  heli_q8_M->Sizes.numBlockIO = (8);   /* Number of block outputs */
  heli_q8_M->Sizes.numBlockPrms = (136);/* Sum of parameter "widths" */
  return heli_q8_M;
}
